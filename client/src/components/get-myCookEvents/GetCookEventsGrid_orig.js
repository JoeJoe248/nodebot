...
class GetCookEventsGrid extends Component {
  ...
  onSubmit(e) {
    ...
    console.log("recipeName: ", this.state.cookEvent.recipeName);
        ...
        <div className="card card-body bg-light mb-3">
          <div className="row">
            <div className="col-lg-6 col-md-4 col-8">
              ...
              <h5>{this.props.recipe ? this.props.recipe.recipeURL : ""}</h5>
              <p>{this.props.recipe ? this.props.recipe.directions1 : ""}</p>
              <p>{this.props.recipe ? this.props.recipe.directions2 : ""}</p>
              <p>
                suggestd wood:{" "}
