...
board.on("ready", function() {
  ...
  celcius.on("change", function() {
    ...
    avgThermistorResistance1 = 1023 / averageSample - 1; //is this right? need parens
    var avgThermistorResistance2 = 0;
    avgThermistorResistance2 = seriesResistor / avgThermistorResistance1;
    //console.log("Average Thermistor resistance2: " + avgThermistorResistance2);

    //do the Steinhart formula
    var steinhart1 = 0;
    var steinhart2 = steinhart1 + avgThermistorResistance2 / thermistorNominal; //is this right? need parens
    //console.log("Steinhart2: " + steinhart2);
    ...
    //console.log("steinhart5: " + steinhart5);
    var steinhart6 = 1.0 / steinhart5;
    //console.log("steinhart6: " + steinhart6);
